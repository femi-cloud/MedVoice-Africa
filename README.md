...
[Features](#What-it-does) · [Architecture]([[#-architecture](#%EF%B8%8F-architecture)](https://github.com/femi-cloud/MedVoice-Africa/blob/main/README.md#%EF%B8%8F-architecture)) · [Setup](#%EF%B8%8F-installation--setup) · [Screenshots](#-screenshots) · [Roadmap](#-roadmap)
